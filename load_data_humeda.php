...
include_once("./formulario_carga_humeda.php");
	...
	if($fh)
	{
		...
		while(($linea = fgets($fh,4096)) !== false)
		{
			if($point == 1)
			{
				...
				{
				  die("<table width='50%'><tr><th>Este archivo no corresponde al tipo de arena <b><font color='#FF0000'>HUMEDA</font></b>, favor de verificar...</th></tr></table>");
				}
			}
		...
		echo "<table width='50%'><tr><th>Carga completa. <font color='#FF0000'>".$nombre."</font></th></tr></table>";
	}
	else
	{
