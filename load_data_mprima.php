...
include_once("./formulario_carga_mprima.php");
	...
	if($fh)
	{
		...
		while(($linea = fgets($fh,4096)) !== false)
		{
			if($point == 1)
			{
				...
				{
				  die("<table width='50%'><tr><th>Este archivo no corresponde al tipo de arena <b><font color='#FF0000'>METERIA PRIMA</font></b>, favor de verificar...</th></tr></table>");
				}
			}
